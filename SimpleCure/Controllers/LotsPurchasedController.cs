...
namespace SimpleCure.Controllers
{
    ...
    public class LotsPurchasedController : Controller
    {
        ...
        public ActionResult NewLotPurchased(Generic<NewLotPurchased_ViewModel> model)
        {
            ...
            {
                var response = _lotsPurchasedFunctions.Add(new LotsPurchased_Models { BudTrim = model.GenericClass.BudTrim, BuyDate = model.GenericClass.BuyDate, CBD = model.GenericClass.CBD, Complete = false, Cost = model.GenericClass.Cost, EnterDate = TimeZoneInfo.ConvertTime(DateTime.Now, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")), Grams = model.GenericClass.Grams, IndPackages = model.GenericClass.IndPackages, Lot_Set = model.GenericClass.Lot_Set, Notes = model.GenericClass.Notes, Pounds = model.GenericClass.Pounds, PricePerGram = model.GenericClass.PricePerGram, PricePerPound = model.GenericClass.PricePerPound, Provider = model.GenericClass.Provider, SatPackages = model.GenericClass.SatPackages, Strains = model.GenericClass.Strains, IsSimpleCure = false, TransportID = model.GenericClass.TransportID, CompletedBy = string.Empty, CompletionDate = null, Split = model.GenericClass.Split, SplitNotes = model.GenericClass.SplitNotes, To_From = model.GenericClass.To_From, TransportLocationStart = model.GenericClass.TransportLocationStart, TransportLocationEnd = model.GenericClass.TransportLocationEnd, IndChocPackages = model.GenericClass.IndChocPackages ?? 0, SatChocPackages = model.GenericClass.SatChocPackages ?? 0 });
        ...
        public ActionResult SaveEditLotPurchased(Generic<ViewLotsPurchased_ViewModel> model)
        {
            ...
            if (model.GenericClass.Complete)
            {
                ...
                model.GenericClass.CompletionDate = TimeZoneInfo.ConvertTime(DateTime.Now, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time"));
            }
            else
            {
            ...
            var response = _lotsPurchasedFunctions.Update(new LotsPurchased_Models { BudTrim = model.GenericClass.BudTrim, BuyDate = model.GenericClass.BuyDate, CBD = model.GenericClass.CBD, Complete = model.GenericClass.Complete, Cost = model.GenericClass.Cost, EnterDate = TimeZoneInfo.ConvertTime(DateTime.Now, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")), Grams = model.GenericClass.Grams, IndPackages = model.GenericClass.IndPackages, Lot_Set = lotset, Notes = model.GenericClass.Notes, Pounds = model.GenericClass.Pounds, PricePerGram = model.GenericClass.PricePerGram, PricePerPound = model.GenericClass.PricePerPound, Provider = model.GenericClass.Provider, SatPackages = model.GenericClass.SatPackages, Strains = model.GenericClass.Strains, ID = model.GenericClass.ID, TransportID = model.GenericClass.TransportID, TransportLocationEnd = model.GenericClass.TransportLocationEnd, TransportLocationStart = model.GenericClass.TransportLocationEnd, Split = model.GenericClass.Split, SplitNotes = model.GenericClass.SplitNotes, To_From = model.GenericClass.To_From, IndChocPackages = model.GenericClass.IndChocPackages ?? 0, SatChocPackages = model.GenericClass.SatChocPackages ?? 0 });
